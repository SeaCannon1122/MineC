...
uint32_t gui_scene_simulate(struct minec_client* game, void* scene, uint32_t scale) {
...
uint32_t gui_scene_render(struct minec_client* game, void* scene, uint32_t scale) {
