...
#include "backend/vulkan/pixelchar_vulkan_fragment_shader.h"
#include "backend/vulkan/pixelchar_vulkan_vertex_shader.h"
...
uint32_t pixelchar_renderer_vk_cmd_render(struct pixelchar_renderer_vk* pcr, VkCommandBuffer cmd, VkExtent2D screen_size) {
	...
	float color_devisor = 5.f;
	float alpha_devicor = 1.4f;
