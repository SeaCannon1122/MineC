...
uint32_t resources_create(struct game_server* game, uint8_t* resource_path) {
...
uint32_t resources_destroy(struct game_server* game) {
...
uint32_t resources_reload(struct game_server* game) {
