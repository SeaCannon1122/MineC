...
"\n"
"layout(binding = 0) buffer font0 { uint font0_bitmaps[]; };\n"
"layout(binding = 1) buffer font1 { uint font1_bitmaps[]; };\n"
"layout(binding = 2) buffer font2 { uint font2_bitmaps[]; };\n"
"layout(binding = 3) buffer font3 { uint font3_bitmaps[]; };\n"
"layout(binding = 4) buffer font4 { uint font4_bitmaps[]; };\n"
"layout(binding = 5) buffer font5 { uint font5_bitmaps[]; };\n"
"layout(binding = 6) buffer font6 { uint font6_bitmaps[]; };\n"
"layout(binding = 7) buffer font7 { uint font7_bitmaps[]; };\n"
"\n"
