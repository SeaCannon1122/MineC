...
layout(location = 0) flat out ivec4 bitmap_index_I_bitmap_thickness_I_modifiers_I_scale;
layout(location = 1) out vec2 fragment_position;
layout(location = 2) out vec4 color;
layout(location = 3) out vec4 background_color;
