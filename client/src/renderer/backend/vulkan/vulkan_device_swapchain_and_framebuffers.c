...
uint32_t vulkan_device_swapchain_and_framebuffers_create(struct minec_client* game) {
...
uint32_t vulkan_device_swapchain_and_framebuffers_destroy(struct minec_client* game) {
