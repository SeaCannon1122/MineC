...
{
	struct renderer_backend_info backend_infos[RENDRER_MAX_BACKEND_COUNT];

	uint32_t backend_count;

	struct renderer_backend_device_info backend_device_infos[RENDERER_MAX_BACKEND_DEVICE_COUNT];
